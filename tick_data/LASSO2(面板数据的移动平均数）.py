...
bid_price3 = rol_mean(bid_price, 3)
bid_volume = clean_list(bid_volume)
bid_volume3 = rol_mean(bid_volume, 3)
ask_price = clean_list(ask_price)
ask_price3 = rol_mean(ask_price, 3)
ask_volume = clean_list(ask_volume)
ask_volume3 = rol_mean(ask_volume, 3)
amount_tick3 = rol_mean(amount_tick, 3)
feature = np.vstack(
    (price3, bid_price3, bid_volume3, ask_price3, ask_volume3, amount_tick, vol, volume_tick)).transpose()
...
file = open('feature_l2.csv', 'w', encoding='utf-8-sig')
